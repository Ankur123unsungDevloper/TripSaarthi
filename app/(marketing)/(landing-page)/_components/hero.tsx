...
const Hero = () => {
  return (
    <div className="flex flex-col h-300 relative bg-[#000] text-white w-full">
      ...
      <div className="relative w-[1000px] mt-[150px] mx-auto h-full grid grid-cols-3 gap-[40px] bottom-30 text-[#000]">
        <div className="relative bg-[linear-gradient(0deg,_#c21833,_transparent)] h-120 overflow-hidden hover:opacity-[0.5] transition duration-500">
          ...
          <div className="absolute w-full h-[60%] bottom-0 p-[20px] text-center">
